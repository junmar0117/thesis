...
{       
        ...
        <form action="completeReportAction_vaw.php" method="POST">
        ...
        <label for="withdisability">With Disability</label><br>
        <input type="radio" id="withoutdisability" name="with_disability" value="No">
        <label for="withoutdisability">Without Disability</label><br>

        <h3>**If With Disability**</h3>
        <input type="radio" id="permanent" name="disability" value="Permanent Disability">
        <label for="permanent">Permanent Disability</label><br>
        <input type="radio" id="temporary" name="disability" value="Temporary Disability">
        <label for="temporary">Temporary Disability</label><br>
