    ...
    <div class="hpFirstSection">
        <div class="hpFirst">
            ...
            <div class="hpFirstleftborder">
                <p style="font-weight:bold;">READ CAREFULLY!</p>
                <p style="font-weight:bold;">Your safety is our priority</p>
        ...
        <div class="indexGuide">
            ...
            <table class="iGp">
                <tr>
                    ...
                    <td><a class="SelConH">TIPS & TECHNIQUES WHILE WAITING FOR RESPONSE</a><br><br>
                        <a class="inputInfoH" >GENERAL</a><br><br>
