...
<head>
    <meta charset = "utf-8">
    <title>AidPack | Barangay Login</title>
...
<body>
    ...
    <div>
        <h2 class="rlch1">Barangay User Login</h2>
        <br>
        ...
        <a href="b_requestReset.php" id="signupinstead">Forgot Password<i class="far fa-question-circle" style="padding-left: 5px;"></i></a>
        <br>
