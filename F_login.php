...
<body>
    ...
    <div>
        <h2 class="rlch1">Firefighter User Login</h2>
        <br>
        ...
        <a href="F_requestReset.php" id="signupinstead">Forgot Password<i class="far fa-question-circle" style="padding-left: 5px;"></i></a>
        <br>
