...
<head>
    <meta charset = "utf-8">
    <title>AidPack | Bureau of Fire Protection Profile</title>
...
{ 
	...
	while($row = mysqli_fetch_array($results)) //display all rows from query    
	{
        ...
        $table_users = $row['f_fname']; // the first username row is passed on to $table_users, and so on until the query is finished
