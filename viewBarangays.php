...
<div class="verticalTabView">
    ...
    <div id="Barangay 834" class="tabcontent">
        ...
        <p>Contact Number: (02) 8986 3178</p>
        <p>Number of Reported Incidents: <?php echo $data1['total1']?></p>
    ...
    <div id="Barangay 835" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data2['total2']?></p>
    ...
    <div id="Barangay 836" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data3['total3']?></p>
    ...
    <div id="Barangay 837" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data4['total4'] ?></p>
    ...
    $data5=mysqli_fetch_assoc($result3);
    ?>
    <div id="Barangay 838" class="tabcontent">
        <h3>Barangay 838</h3>
        <p>Address: Roadd 2, 837 Pandacan, Manila, 1011 Metro Manila</p>
        <p>Contact Number: 0906 214 1984</p>
        <p>Number of Reported Incidents: <?php echo $data5['total5'] ?></p>
    ...
    <div id="Barangay 839" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data6['total6'] ?></p>
    ...
    <div id="Barangay 841" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data8['total8'] ?></p>
    ...
    <div id="Barangay 842" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data['total10'] ?></p>
    ...
    <div id="Barangay 843" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data01['total01'] ?></p> 
    ...
    <div id="Barangay 844" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data02['total02'] ?></p>
    ...
    <div id="Barangay 845" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data03['total03'] ?></p>
    ...
    <div id="Barangay 846" class="tabcontent">
        ...
        <p>Contact Number: (02) 8588 2530</p>
        <p>Number of Reported Incidents: <?php echo $data04['total04'] ?></p>
    ...
    <div id="Barangay 847" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data05['total05'] ?></p>
    ...
    $data306=mysqli_fetch_assoc($result06);
    ?>
    <div id="Barangay 848" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data06['total06'] ?></p>
    ...
    <div id="Barangay 849" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data07['total07'] ?></p>
    ...
    <div id="Barangay 850" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data08['total08'] ?></p>
    ...
    <div id="Barangay 851" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data09['total09'] ?></p>
    ...
    <div id="Barangay 852" class="tabcontent">
        ...
        <p>Contact Number: No Data Available</p>
        <p>Number of Reported Incidents: <?php echo $data010['total010'] ?></p>
    ...
    <div id="Barangay 853" class="tabcontent">
        ...
        <p>Contact Number: (02) 8588 2530</p>
        <p>Number of Reported Incidents: <?php echo $data001['total001'] ?></p>
    ...
    <div id="Barangay 855" class="tabcontent">
        ...
        <p>Contact Number: No Data Available</p>
        <p>Number of Reported Incidents: <?php echo $data002['total002'] ?></p>
    ...
    <div id="Barangay 856" class="tabcontent">
        ...
        <p>Number of Reported Incidents: <?php echo $data003['total003'] ?></p>
    ...
    <div id="Barangay 857" class="tabcontent">
        ...
        <p>Contact Number: No Data Available</p>
        <p>Number of Reported Incidents:<?php echo $data004['total004'] ?></p>
    ...
    //LAST
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='858'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='859'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='860'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='861'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='862'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='863'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='864'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='865'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='866'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    <div id="Barangay 866" class="tabcontent">
        ...
        <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='867'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='868'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='869'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='870'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='871'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
    ...
    <?php
    require 'connection.php';  
    $result3=mysqli_query($con,"SELECT count(*) as total3 from reports WHERE barangay='872'");
    $data3=mysqli_fetch_assoc($result3);
    ?>
