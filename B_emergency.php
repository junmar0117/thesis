...
<nav>
   ...
   <div class="CreportHeader">
    <h1>Local Barangay Incident Report</h1>
    ...
    <input id="long" name="long" placeholder="Move the marker" disabled/>
            ...
            <label for="placeOfInci" style="color:red;font-size:14px">Drag the marker to the area of incident</label>
...
document.getElementById("defaultOpen").click();
        ...
        <input type="submit" name="b_upload" value="Submit" onclick="sendEmail()">
        </form>
    </div>
    <script>
var map;
