...
<head>
    <meta charset = "utf-8">
    <title> AidPack | Civilian Profile </title>
                    ...
                    while($row = mysqli_fetch_array($query))
                        {
                            ...
                            Print '<td class="profileInfoContent">'. $row['fname'] . " " . $row['lname'] . "</td>";
                            Print '<th class="profileInfoHeader">Username</th>';
                            Print '<td class="profileInfoContent">'. $row['username'] . "</td>";
                            Print "</tr>";
                            Print "<tr>";
                            Print '<th class="profileInfoHeader">Birthday</th>';
                            Print '<td class="profileInfoContent">'. $row['birthday'] . "</td>";
